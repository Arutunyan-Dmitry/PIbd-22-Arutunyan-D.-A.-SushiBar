...
namespace SushiBarView
{
    public partial class FormImplementer : Form
    {
        ...
        private void FormImplementer_Load(object sender, EventArgs e)
        {
            if (id.HasValue)
            {
                try
                {
                    ...
                    if (view != null)
                    {
                        textBoxFLM.Text = view.ImplementerFLM;
        ...
        {
            if (string.IsNullOrEmpty(textBoxFLM.Text))
            {
            ...
            {
                MessageBox.Show("Заполните время выполнения", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            try
            {
                ...
                {
                    Id = id,
                    ImplementerFLM = textBoxFLM.Text,
